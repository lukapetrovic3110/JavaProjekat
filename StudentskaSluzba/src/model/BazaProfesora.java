...
public class BazaProfesora {
	...
	private void initProf() {
		...
		predmeti3.add(new Predmet("PP007", "Paralelno programiranje", 5, 3));
		
		ArrayList<Predmet> predmeti4 = new ArrayList<Predmet>();
		predmeti4.add(new Predmet("RVP33", "Racunarstvo visokih performanski", 7, 4));
		
		ArrayList<Predmet> predmeti5 = new ArrayList<Predmet>();
		
		ArrayList<Predmet> predmeti6 = new ArrayList<Predmet>();
		...
		profesori.add(new Profesor("Elena", "Milenkovic", "08.11.1985.", "Tolstojeva 52, Novi Sad", "021/834-901", "elena.milenkovic@mailinator.com", "Dositeja Obradovica 6, Novi Sad, Nastavni blok 217", "003330976", titule.MAGISTAR, zvanja.DOCENT, predmeti5));
		profesori.add(new Profesor("Teodor", "Mladenovic", "14.12.1983.", "Jovana Subotica 33, Novi Sad", "021/441-007", "teodor.mladenovic@mailinator.com", "Dositeja Obradovica 6, Novi Sad, NTP M35", "007441998", titule.DOKTORNAUKA, zvanja.DOCENT, predmeti6));
	}
